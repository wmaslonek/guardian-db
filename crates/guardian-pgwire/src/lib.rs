//! # guardian-pgwire
//!
//! A PostgreSQL wire-protocol server in front of the [`guardian_sql`] engine.
//!
...
use guardian_sql::engine::{Database, Session};
use guardian_sql::{ExecResult, OutField, RelationalStorage, SqlType, SqlValue};
...
fn pg_error(e: guardian_sql::SqlError) -> PgWireError {
