...
use crate::p2p::events::new_event_message;
                            ...
                            Ok(current_peers) => {
                                ...
                                for peer in &current_peers {
                                    if !last_peers.contains(peer) {
                                        ...
                                        let join_event: events::Event = Arc::new(crate::traits::EventPubSub::Join {
                                            peer: *peer,
                                ...
                                for peer in &last_peers {
                                    if !current_peers.contains(peer) {
                                        ...
                                        let leave_event: events::Event = Arc::new(crate::traits::EventPubSub::Leave {
                                            peer: *peer,
                                            topic: topic_name.clone()
                                        });
